...
public class HarvestController {
    ...
    public Msg deletByIds(@ApiParam(name = "idList",value = "需删除重大成果的id数组")@RequestParam List<Integer> idList){
        try {
            harvestService.deletByIds(idList);
            return Msg.success();
        }catch (Exception e){
            return Msg.fail(e);
        }
