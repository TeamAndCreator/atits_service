...
public class TaskProgress {
    ...
    public TaskProgress(Integer id,Integer subTaskId,String subTaskName,Integer bearerId,String bearerName,String title,String content,String date,int state){
        this.id=id;
